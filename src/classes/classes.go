...
var Classes = map[string]Classe{
	"Survivant": {
		...
		Inventory: []string{}, MaxInventory: 10, ManaMax: 20, Specialite: "Résistance équilibrée",
	},
	"Punk": {
		...
		Inventory: []string{}, MaxInventory: 10, ManaMax: 20, Specialite: "Bonus de dégâts critiques",
	},
	"Médecin de fortune": {
		...
		Inventory: []string{}, MaxInventory: 10, ManaMax: 20, Specialite: "Efficacité de soin augmentée",
	},
	"Sauveur": {
		...
		Inventory: []string{}, MaxInventory: 10, ManaMax: 20, Specialite: "Réduction de dégâts subis",
	},
}
